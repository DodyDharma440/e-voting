<!--Header Component-->
<?= view('template/app/pemilih/header') ?>
    ...
    <div class="container-fluid position-relative p-0" style="min-height: 100%">
        ...
        <nav id="sidebarCollapse" class="bg-dark my-sidebar">
            ...
            <div class="list-group sidebar-menu">
                ...
                <a href="<?= base_url('/pemilih/dashboard') ?>" class="list-group-item sidebar-item <?= $active == "dashboard" ? "active" : false; ?>">
                ...
                <a href="<?= base_url('/pemilih/bilik_suara') ?>" class="list-group-item sidebar-item <?= $active == "bilik_suara" ? "active" : false; ?>">
                    <div class="icon-sidebar"><i class="fas fa-users"></i></div>
                    <div class="d-none d-md-block pl-4 ml-2 text-sidebar-menu">Bilik Suara</div>
                </a>
                <a href="<?= base_url('pemilih/quick_count') ?>" class="list-group-item sidebar-item <?= $active == "hitung" ? "active" : false; ?>">
                ...
                <a href="<?= base_url('pemilih/edit_profil') ?>" class="list-group-item sidebar-item <?= $active == "edit" ? "active" : false; ?>">
            ...
            <nav class="navbar navbar-light fixed-top my-navbar" id="myNavbar">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu right dropdown-profile" aria-labelledby="menuProfile">
                        <a class="dropdown-item pt-2 pb-2" href="<?= base_url('pemilih/dashboard') ?>">
                            <div class="row">
                        ...
                        <a class="dropdown-item pt-2 pb-2" href="<?= base_url('pemilih/edit_profil') ?>">
                            <div class="row">
                                <div class="col-3 p-0 text-center">
        ...
        <!--Footer Component-->
        <?= view('template/app/pemilih/footer') ?>
    </div>
</div>